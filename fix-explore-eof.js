...
// Also let's fix the HTML entities again since I checked out the file and we need to fix it safely
const badMatchStr1 = `{isHighMatch ? "🔥" : "✨"} {matchScore}% Match`;
const badMatchStr2 = `{isHighMatch ? "dY"" : "o""} {matchScore}% Match`;
...
console.log("Restored missing lines and fixed emojis");
