...
const headerRegex = /<header className=\{`sticky top-0 z-40 px-4 py-3 border-b flex items-center justify-between \$\{sidebar\}`\}>.*?<\/header>/s;
...
const newHeader = `<header className="sticky top-0 z-40 px-5 py-4 backdrop-blur-2xl bg-white/70 dark:bg-gray-950/70 border-b border-gray-200/50 dark:border-gray-800/50 flex items-center justify-between">
