...
export default function Home() {
    ...
    return (
        <div className="w-full flex flex-col items-center bg-background scroll-smooth font-sans bg-grid transition-all duration-1000">
            ...
            {/* HERO SECTION - PRO REFINEMENT ENT-STABLE */}
            ...
            {/* ABOUT / METRICS SECTION - PROFESSIONAL METRICS */}
            <section id="about" className="max-w-7xl w-full mx-auto px-6 mb-44 relative z-20">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="grid grid-cols-2 gap-5">
                        ...
                        {/* Bottom Full-Width Status Banner */}
            ...
            <section id="features" className="max-w-7xl w-full mx-auto px-6 mb-48 relative z-20">
                ...
                {/* 
                  ...
                  ┌──────────────────────┬─────────────┐
                  │  Instant Matching     │ Peer Network│
                  │  (col 1-2, row 1-2)  │ (col 3 row1)│
                  │                      ├─────────────┤
                  │                      │   Exchange  │
                  │                      │ (col 3 row2)│
                  ├──────────┬───────────┴─────────────┤
                  │  Profiles│   Open to All Disciplines│
                  │ (col 1)  │   (col 2-3)             │
                  └──────────┴─────────────────────────┘
                */}
                <div className="grid grid-cols-1 md:grid-cols-3 md:grid-rows-[1fr_1fr_auto] gap-4">

                    {/* HERO: col 1-2, rows 1-2 */}
                    <motion.div
                    ...
                    >
                        ...
                        <div>
                            ...
                            <h3 className="text-2xl md:text-3xl font-heading font-black text-foreground mb-4 uppercase tracking-tight">
                    ...
                    {/* Card 5: col 2-3, row 3 (wide banner) */}
                    <motion.div
            ...
            {/* ARCHITECT COLLECTIVE - COMPACT PRECISION GRID */}
                    ...
                    {teamData.sort((a, b) => (a.level ?? 3) - (b.level ?? 3)).map((member, i) => {
                        ...
                        return (
                            <motion.div 
                                ...
                                viewport={{ once: true }}
                                className={`group p-8 rounded-[3.5rem] glass-elite transition-all duration-500 flex flex-col relative overflow-hidden h-full ${isFounder ? 'lg:col-span-2 lg:p-10' : ''}`}
                            >
                                {/* PERMANENT SOCIALS */}
                        ...
                        <div className="md:col-span-5 flex flex-col">
                            <Link href="/" className="flex items-center gap-4 mb-8 group w-fit cursor-pointer">
                                <div className="w-11 h-11 rounded-xl bg-foreground/5 border border-border flex items-center justify-center p-2 group-hover:border-primary/40 transition-all">
                                    <img src="https://www.swapifhy.com/assets/swapifhy-logo-DPxPDdg-.png" alt="Swapifhy Logo" className="w-full h-full object-contain" />
                                </div>
                            ...
                            {/* INQUIRY FORM — for press, partnerships, and general contact */}
                            {/* NOTE: When stable v1.0 launches, beta users will be grandfathered with:
                                  - Preserved accounts and skill history
